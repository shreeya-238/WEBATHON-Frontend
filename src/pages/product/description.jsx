    ...
    const fetchProduct = async () => {
      try {
        ...
        setProduct({
          ...
          description: "Dairy-free almond milk made from premium almonds. No added sugar, lactose-free, and enriched with calcium and Vitamin D. Perfect for smoothies, cereals, and coffee.",
          price: 199,
          currency: "INR",
          image_url: "https://images.unsplash.com/photo-1544025162-d76694265947?w=800&auto=format&fit=crop&q=60",
          barcode: "8901234567890",
          specifications: {
            "Weight": "1L",
            "Ingredients": "Water, Almonds (4%), Calcium Carbonate, Sea Salt, Vitamin D2",
            "Nutritional Value": "Energy 30kcal, Protein 1g, Fat 2.5g per 100ml",
            ...
            "Certifications": "FSSAI, Non-GMO, Vegan"
          },
          made_in_india: true,
          eco_friendly: true,
          FSSAI_certified: true,
          trust_badges: ["FSSAI Certified", "Vegan", "Non-GMO"],
          average_rating: 4.4,
          total_reviews: 98,
          total_complaints: 2,
          risk_score: 10,
