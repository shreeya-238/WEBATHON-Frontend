...
//     if (!consumerProfile || !token) {
//       setError('User not logged in or profile missing.');
//       return;
//     }
...
//       const payload = {
//         name: `${consumerProfile.firstName} ${consumerProfile.lastName}`.trim(),
//         productId: id,
...
//           </Link>
//           <div className="text-sm text-gray-600">Welcome, {consumerProfile ? `${consumerProfile.firstName} ${consumerProfile.lastName}` : 'User'}</div>
//         </div>
//       </div>
